% filename:BoxCB
% Purpose:toggles image on box to show player’s current move, checks wins, AI move, and switches player
% date: 11/6/18
...
WhoseTurn = -WhoseTurn %1 or -1 to indicated player turn init in TicTacInit %if EndPB, this will go into that file
